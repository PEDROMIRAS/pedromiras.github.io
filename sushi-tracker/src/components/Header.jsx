...
export default function Header({ playerName, onOpenSettings, onOpenHistory }) {
    return (
        <header className="flex justify-between items-center p-6 bg-black border-b border-black">
            {/* Botón de Ajustes (Izquierda) */}
            <button
                onClick={onOpenSettings}
                className="text-gray-400 hover:bg-gray-800 hover:text-white p-2 rounded-xl transition-colors cursor-pointer"
